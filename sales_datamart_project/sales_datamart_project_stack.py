...
class LambdaStack(core.Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        dev_account_id = "211125765812"  # Replace with your development account ID
        ...
        my_lambda = Function(
            self,
            "MyLambda",
            runtime=Runtime.PYTHON_3_10,  # Choose the appropriate runtime
            code=my_lambda_code,
            handler="lambda_function.lambda_handler",  # Replace with your handler function
            environment=env_vars,
            role=Role.from_role_arn(self, 'lambdarole1', role_arn=f'arn:aws:iam::{account_id}:role/LambdaStackerRole'),
            memory_size=128,
